...
namespace LPsolveSBML
{
    ...
    public class FluxBalance
    {
        ...
        public FluxBalance(string sbmlContent) : this()
        {
            SBML = sbmlContent;
        ...
        private void InitializeFromSBMLDocument(SBMLDocument doc)
        {
            ...
            for (int i = 0; i < numConstraints; i++)
            {
                ...
                Constraints.Add(new LPsolveConstraint(constraint.getReaction(), GetOperator(constraint.getOperation()), constraint.getValue()));
            }
